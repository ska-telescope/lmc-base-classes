...
class TestSKALogger(object):
    ...
    def test_SetCentralLoggingLevel(self, tango_context, setup_log_test_device, logging_level, logging_target):
    ...
    def test_SetElementLoggingLevel(self, tango_context, setup_log_test_device, logging_level, logging_target):
    ...
    def test_SetStorageLoggingLevel(self, tango_context, setup_log_test_device, logging_level, logging_target):
