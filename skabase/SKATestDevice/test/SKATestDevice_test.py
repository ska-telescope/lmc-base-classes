...
class TestSKATestDevice(object):
    ...
    # PROTECTED REGION ID(SKATestDevice.test_LoggingLevel_decorators) ENABLED START #
    # PROTECTED REGION END #    //  SKATestDevice.test_loggingLevel_decorators
    def test_loggingLevel(self, tango_context):
        ...
        # PROTECTED REGION END #    //  SKATestDevice.test_loggingLevel
