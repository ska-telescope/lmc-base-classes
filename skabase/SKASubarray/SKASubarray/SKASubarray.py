...
class SKASubarray(SKAObsDevice):
    ...
    def _is_command_allowed(self, command_name):
        """Determine whether the command specified by the
        command_name parameter should
        ...
        True or False: boolean
            A True is returned when the device is in the allowed states
            and modes to execute the command. Returns False if the
            command name is not in the list of
    ...
    def _validate_capability_types(self, command_name, capability_types):
        ...
        passed on to the command specified
    ...
    def _validate_input_sizes(self, command_name, argin):
        ...
        argin: tango.DevVarLongStringArray
            A tuple of two lists representing
            [number of instances][capability types]
    ...
    def init_device(self):
        ...
        # self._configured_capabilities is gonna be kept as a dictionary
        # internally. The keys and value will represent the capability
        # type name and the number of instances, respectively.
        try:
            self._configured_capabilities = dict.fromkeys(self.CapabilityTypes, 0)
        except TypeError:
            # Might need to have the device property be
            # mandatory in the database.
    ...
    def always_executed_hook(self):
        # PROTECTED REGION ID(SKASubarray.always_executed_hook)
        # ENABLED START #
        pass
    ...
    def read_activationTime(self):
        # PROTECTED REGION ID(SKASubarray.activationTime_read)
        # ENABLED START #
        """
    ...
    def read_assignedResources(self):
        # PROTECTED REGION ID(SKASubarray.assignedResources_read)
        # ENABLED START #
        """
    ...
    def read_configuredCapabilities(self):
        # PROTECTED REGION ID(SKASubarray.configuredCapabilities_read)
        # ENABLED START #
        """
    ...
    def DeconfigureAllCapabilities(self, argin):
        # PROTECTED REGION ID(SKASubarray.DeconfigureAllCapabilities)
        # ENABLED START #i
