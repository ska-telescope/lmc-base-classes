...
nitpick_ignore = [
    ...
    ("py:class", "ska_tango_base.csp.controller_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.obs.obs_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.obs.obs_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.obs.obs_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.obs.obs_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.subarray.subarray_device.ComponentManagerT"),
    ("py:class", "ska_tango_base.csp.subarray.subarray_device.ComponentManagerT"),
    ...
    ("py:class", "ska_tango_base.testing.reference.reference_base_component_manager.ComponentT"),
]
