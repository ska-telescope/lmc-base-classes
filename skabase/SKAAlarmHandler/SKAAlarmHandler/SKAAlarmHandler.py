...
class SKAAlarmHandler(SKABaseDevice):
    ...
    def always_executed_hook(self):
        # PROTECTED REGION ID(SKAAlarmHandler.always_executed_hook)
        # ENABLED START #
        pass
    ...
    def read_statsNrAlerts(self):
        # PROTECTED REGION ID(SKAAlarmHandler.statsNrAlerts_read)
        # ENABLED START #
        """
    ...
    def read_statsNrAlarms(self):
        # PROTECTED REGION ID(SKAAlarmHandler.statsNrAlarms_read)
        # ENABLED START #
        """
    ...
    def read_statsNrNewAlarms(self):
        # PROTECTED REGION ID(SKAAlarmHandler.statsNrNewAlarms_read)
        # ENABLED START #
        """
    ...
    def read_statsNrUnackAlarms(self):
        # PROTECTED REGION ID(SKAAlarmHandler.statsNrUnackAlarms_read)
        # ENABLED START #
        """
    ...
    def read_statsNrRtnAlarms(self):
        # PROTECTED REGION ID(SKAAlarmHandler.statsNrRtnAlarms_read)
        # ENABLED START #
        """
    ...
    def read_activeAlerts(self):
        # PROTECTED REGION ID(SKAAlarmHandler.activeAlerts_read)
        # ENABLED START #
        """
    ...
    def read_activeAlarms(self):
        # PROTECTED REGION ID(SKAAlarmHandler.activeAlarms_read)
        # ENABLED START #
        """
    ...
    def GetAlarmData(self, argin):
        ...
        :param argin: Name of the alarm
        :return: JSON string containing all alarm data
        """
        return ""
