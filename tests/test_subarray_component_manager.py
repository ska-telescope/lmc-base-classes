...
class TestSubarrayComponentResourceManager:
    ...
    def resource_manager(self):
        ...
        :return:
            :py:class:`SubarrayComponentManager._SubarrayComponent._ResourceManager`
        """
        return SubarrayComponentManager._SubarrayComponent._ResourceManager()
...
class TestSubarrayComponentManager:
    ...
    def component(self, mock_capability_types, initial_power_mode, initial_fault):
        return SubarrayComponentManager._SubarrayComponent(
