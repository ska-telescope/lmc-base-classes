...
class TestSKAMaster(object):
    ...
    def mocking(cls):
        ...
        # PROTECTED REGION ID(SKAMaster.test_mocking)
        # ENABLED START #
        # PROTECTED REGION END #    //  SKAMaster.test_mocking

    def test_properties(self, tango_context):
        # Test the properties
        # PROTECTED REGION ID(SKAMaster.test_properties)
        # ENABLED START #
        # PROTECTED REGION END #    //  SKAMaster.test_properties
        pass

    # PROTECTED REGION ID(SKAMaster.test_State_decorators)
    # ENABLED START #
    # PROTECTED REGION END #    //  SKAMaster.test_State_decorators
    def test_State(self, tango_context):
        """Test for State"""
        # PROTECTED REGION ID(SKAMaster.test_State)
        # ENABLED START #
        assert tango_context.device.State() == DevState.UNKNOWN
        # PROTECTED REGION END #    //  SKAMaster.test_State

    # PROTECTED REGION ID(SKAMaster.test_Status_decorators)
    # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_GetMetrics_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_GetMetrics_decorators
    def test_GetMetrics(self, tango_context):
        """Test for GetMetrics"""
        # PROTECTED REGION ID(SKAMaster.test_GetMetrics)
        # ENABLED START #
        assert tango_context.device.GetMetrics() == ""
        # PROTECTED REGION END #    //  SKAMaster.test_GetMetrics

    # PROTECTED REGION ID(SKAMaster.test_ToJson_decorators)
    # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_GetVersionInfo_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_GetVersionInfo_decorators
    ...
    # PROTECTED REGION ID(SKAMaster.test_isCapabilityAchievable_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_isCapabilityAchievable_decorators
    def test_isCapabilityAchievable(self, tango_context):
        """Test for isCapabilityAchievable"""
        # PROTECTED REGION ID(SKAMaster.test_isCapabilityAchievable)
        # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_elementLoggerAddress_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_elementLoggerAddress_decorators
    def test_elementLoggerAddress(self, tango_context):
        """Test for elementLoggerAddress"""
        # PROTECTED REGION ID(SKAMaster.test_elementLoggerAddress)
        # ENABLED START #
        assert tango_context.device.elementLoggerAddress == ''
        # PROTECTED REGION END #    //  SKAMaster.test_elementLoggerAddress

    # PROTECTED REGION ID(SKAMaster.test_elementAlarmAddress_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_elementAlarmAddress_decorators
    def test_elementAlarmAddress(self, tango_context):
        """Test for elementAlarmAddress"""
        # PROTECTED REGION ID(SKAMaster.test_elementAlarmAddress)
        # ENABLED START #
        assert tango_context.device.elementAlarmAddress == ''
        # PROTECTED REGION END #    //  SKAMaster.test_elementAlarmAddress

    # PROTECTED REGION ID(SKAMaster.test_elementTelStateAddress_decorators)
    # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_elementDatabaseAddress_decorators)
    # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_controlMode_decorators)
    # ENABLED START #
    ...
    # PROTECTED REGION ID(SKAMaster.test_maxCapabilities_decorators)
    # ENABLED START #
    # PROTECTED REGION END #
    # //  SKAMaster.test_maxCapabilities_decorators
    def test_maxCapabilities(self, tango_context):
        """Test for maxCapabilities"""
        # PROTECTED REGION ID(SKAMaster.test_maxCapabilities)
        # ENABLED START #
        assert tango_context.device.maxCapabilities == ('',)
        # PROTECTED REGION END #    //  SKAMaster.test_maxCapabilities

    # PROTECTED REGION ID(SKAMaster.test_availableCapabilities_decorators)
    # ENABLED START #
    ...
    def test_availableCapabilities(self, tango_context):
        ...
        # PROTECTED REGION ID(SKAMaster.test_availableCapabilities)
        # ENABLED START #
