...
if __name__ == "__main__":
    ...
    draw(
        ska_tango_base.base_device.op_state_model._OpStateMachine,
        "api/base_device/_OpStateMachine_autogenerated.png",
    )
    draw(
        ska_tango_base.base_device.admin_mode_model._AdminModeMachine,
        "api/base_device/_AdminModeMachine_autogenerated.png",
    )
    draw(
